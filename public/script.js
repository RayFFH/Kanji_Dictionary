...
async function getRandomKanji() {
    try {
        ...
        const data = await response.json();
        const data2 = data.randomKanji
        console.log('Random Kanji:', data);
        console.log('Random Kanji:', data2.Meaning);
        ...
        const randomKanji = data2.Kanji_Character
        ...
        randomKanjiElement.setAttribute('data-kanji-info', JSON.stringify(data2.Kanji_Character));

        randomKanjiElement.innerText = data2.Kanji_Character;
...
async function recognizeKanji() {
    try {
        ...
        console.log("Kanji info:", kanjiInfo)
        ...
        if (currentUser) {
            ...
            if (response.ok) {
                ...
                await getKnownKanji();
                await fetchAndDisplayNHKNews('仕');
                console.log("Done")
            } else {
